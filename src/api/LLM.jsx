...
export default async function FetchLLMResponse(noOfQuestions, pdf, typeOfQuestion) {
  ...
  if (typeOfQuestion === "multiple-choice") {
    messages = [
      ...
      { 
        "role": "user", 
        "content": `Given the provided data, generate ${noOfQuestions} multiple-choice questions with answers. There should be 4 choice options. Here's the data: ${text}. Only respond with the JSON text as this answer will be fed directly into the model.`
      }
    ];
